---
aliases: []
date created: Tuesday, 25. November 2025, 10:11
...
**Context/Example**: A company may deploy an IDS to monitor incoming network traffic for patterns that match known [Malware](<./Attacks/Malware/Malware.md>) signatures or unusual activity, such as repeated failed login attempts. When a potential intrusion is detected, the system generates alerts for security personnel to investigate.
