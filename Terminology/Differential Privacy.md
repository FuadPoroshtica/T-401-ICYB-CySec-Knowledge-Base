...
**Definition**: *Differential privacy* is a formal privacy framework that ensures the output of a computation does not significantly change whether any single individual’s data is included or excluded. It protects individuals by adding carefully calibrated randomness (noise) to data or model training.
