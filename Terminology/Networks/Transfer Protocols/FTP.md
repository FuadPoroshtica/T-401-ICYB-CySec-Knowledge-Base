...
FTP does not provide built-in encryption, which means that data, including usernames and passwords, is transmitted in plain text. To enhance security, secure variants of FTP, such as FTPS (FTP over SSL/TLS) and SFTP (SSH File Transfer Protocol), are commonly used.
