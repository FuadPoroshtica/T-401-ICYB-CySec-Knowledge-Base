...
# HTTP
**HTTP** stands for **Hypertext Transfer Protocol**. It is an [Application Layer](../OSI%20Model/7-Application%20Layer.md) protocol used for transmitting hypermedia documents, such as HTML, over the internet. HTTP is the foundation of data communication on the World Wide Web.
