...
(Not to be confused with the [TCP IP Model](<../TCP IP Model/TCP IP Model.md>))
...
5. **[Session Layer](5-Session Layer.md) (Layer 5):** Manages sessions or connections between applications. Establishes, maintains, and terminates connections. (E.g., <abbr title="Application Programming Interface">API</abbr>s, sockets.)
6. **[Presentation Layer](6-Presentation Layer.md) (Layer 6):** Translates data formats between the application and the network. Handles data encryption, compression, and translation. (E.g., <abbr title="Secure Sockets Layer">SSL</abbr>/[TLS](<../TLS.md>), data encoding.)
...
![](<../../../zAttachments/Pasted image 20251212123248.png>)

![](<../../../zAttachments/Pasted image 20251212123211.png>)
