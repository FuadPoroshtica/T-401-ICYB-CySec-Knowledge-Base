...
The **Network Layer** is the third layer in the [OSI Model](OSI Model.md) of computer networking.
...
The Network Layer works closely with the [Data Link Layer](2-Data Link Layer.md) to provide end-to-end data delivery across multiple networks.
