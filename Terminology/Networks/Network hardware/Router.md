...
- (Unlike [Switches](Switch.md), routers operate at Layer 3 ([Network Layer](../OSI%20Model/3-Network%20Layer.md)) of the [OSI Model](../OSI%20Model/OSI%20Model.md).)
...
- NAT (Network Address Translation).
    - NAT is for sharing a *single* public [IP](../TCP%20IP%20Model/IP.md) address among *multiple* devices on a local network. What it does is that it translates the private [IP](../TCP%20IP%20Model/IP.md) addresses of devices on the local network to the public [IP](../TCP%20IP%20Model/IP.md) address when they access the internet, and vice versa for incoming traffic.
