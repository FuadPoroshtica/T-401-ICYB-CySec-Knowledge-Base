...
| **CAM**                                                | Content Addressable Memory – special memory in switches used for fast lookup tables (e.g., MAC→port).      |
...
| **v12n**<br>(v + 12 letters + n), similar to i18n/l10n | Abbreviation for “virtualization”                                                                          |
