...
**Definition**: A hypervisor that runs as a normal application on a host [OS](<../Systems & Plaforms/Operating System.md>) like Windows, macOS, or Linux.

**Context/Example**: VirtualBox or VMware Workstation installed in your desktop [OS](<../Systems & Plaforms/Operating System.md>); the hypervisor is “just another program” the [OS](<../Systems & Plaforms/Operating System.md>) is running.
