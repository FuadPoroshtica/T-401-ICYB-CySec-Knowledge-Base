...
**Definition**: Special calls from a [paravirtualized](Paravirtualization.md) guest OS to the [Hypervisor](../Hypervisor.md), similar to how system calls go from user space to the [Kernel](../../Systems%20&%20Plaforms/Kernel.md).
