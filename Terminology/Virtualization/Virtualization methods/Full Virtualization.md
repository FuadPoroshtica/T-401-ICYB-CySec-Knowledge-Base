...
**Definition**: A virtualization method where the [hypervisor](../Hypervisor.md) fully simulates the hardware so the guest OS doesn’t need to know it’s virtualized.
