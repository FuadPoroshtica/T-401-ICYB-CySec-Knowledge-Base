...
**Definition**: *k-anonymity* is a privacy model that ensures each individual in a released dataset is indistinguishable from at least **k − 1** other individuals based on a set of identifying attributes (quasi-identifiers). This reduces the risk of re-identification.
