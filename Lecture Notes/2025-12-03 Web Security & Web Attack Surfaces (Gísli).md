...
5. **Injection**: Flaws such as SQL, NoSQL, [OS](<../Terminology/Systems & Plaforms/Operating System.md>), and LDAP injection occur when untrusted data is sent to an interpreter as part of a command or query.
